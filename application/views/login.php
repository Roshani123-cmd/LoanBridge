                            ...
                            <div class=" col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?= $action; ?>">
                                        ...
                                        <!-- <div class="mt-3">
                    <a class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" href="<?php echo site_url('users/index'); ?>">SIGN IN</a>
                  </div> -->
                                    ...
                                    <div class="text-center">
                                        <a class="small"
                                            href="<?php echo site_url('Welcome/forgot_password'); ?>">Forgot
                                            Password?</a>
                                    </div>
                                    <div class="text-center">
...
function showhidepassword() {
    var checkClassType = $('#exampleInputPassword').attr('type');
    if (checkClassType === 'password') {
        $('#exampleInputPassword').prop('type', 'text');
        $('#togglepassword').prop('class', 'fa fa-eye-slash');
    } else {
        $('#exampleInputPassword').prop('type', 'password');
