                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="<?= site_url('Banks/deleteall_action'); ?>">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $this->Bank_model->time_ago($customerrow->created); ?>
                                                    </td>
                                                    <td>

                                                        <a href="<?= site_url('Banks/view_action/' . ($customerrow->edit_id)); ?>"
                                                            class="mdi mdi-eye btn btn-primary btn-sm"><span
                                                                class="fa fa-eye"></a>
                                                        <a href="<?= site_url('Banks/update/' .($customerrow->edit_id)); ?>"
                                                            class="mdi mdi-pencil btn btn-warning btn-sm"><span
                                                                class="fa fa-edit"></span></a>
                                                        <a href="<?= site_url('Banks/delete_action/' .$customerrow->edit_id); ?>"
