    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url('Welcome/RequestLoan'); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputField1" name="inputField1"
                    ...
                    <div class="form-group">
                        ...
                        <select name="country_id" class="form-control " onchange="getStates(this.value)">
                            ...
                            <?php foreach ($GetBanks as $Bankrow) {  ?>
